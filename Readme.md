...
网站名称 | 中大南方大数据学习踩坑空间
---|---
网址 | [https://luojiahao.me/](https://luojiahao.me/)
站长| 罗家濠 161013072
运营报告撰写人| 罗家濠 161013072


# 1.策划

### 1.1策划文档与网站地图：
- 网站建设目标：分享大数据的相关知识，构建一个共有的学习平台，用户可以在讨论区自由讨论学习心得，同时邀约一些业界大咖解答专业性问题，致力于打造一个大数据平台经济。

- 目标用户画像：

<img src="https://raw.githubusercontent.com/LUOJIHAO/web-operation/master/img/91cb7b351b347f79b6f58e51b3381a7.jpg" width = "450" height = "200" div align=right /> | <br/>姓名：勇勇</br><br/>年龄：21岁</br>职业：大学生
---|---
人物简介| 目前正在学校学习大数据的相关知识，如数据的获取及处理，大数据可以运用的领域等。对大数据只是有较高的求知欲望，在学习过程中有自己的见解，想通过一些平台去发表自己的看法和交流学习心得。
用户行为 | 多数情况下使用电脑设备获取网站信息，有时候会使用手机。 网站浏览频率：在学习期间会上网站获取相关学习资料。
用户态度和观点 |喜欢清新自然、简洁明了的风格，对于喜欢的颜色有多种看法。在浏览网站的时候更注重网站的布局还有展示的内容。
痛点| 目前网上大数据知识较为枯燥无味，课堂所学知识有限且老师讲课速度过快，想寻找一个平台不仅能学习同时也能发表一些自己在学习过程中所遇到的问题能有业界大咖解答。

<img src="https://raw.githubusercontent.com/LUOJIHAO/web-operation/master/img/timg%20(1).jpg" width = "350" height = "200" div align=right /> 图片来源[morecoder](http://www.morecoder.com/article/1113541.html)| <br/>姓名：豪豪</br><br/>年龄：29岁</br>职业：数据分析师
---|---
人物简介| 目前在某公司从事大数据分析的工作，已从业多年，专业知识过硬，但遇到一些业界新的事物的出现，需要找到一个可以交流讨论的地方。
用户行为 | 使用电脑设备获取网站信息。实名制登录，可以为自己的简历添加一笔。 网站浏览频率：工作之余会上网站浏览信息和发表评论。
用户态度和观点 |喜欢未来科幻风的主题，注重网站展示的内容。
痛点 | 自己对于行业内的一些领域有一定的经验，想寻找一个专业性较强的平台去分享自己的见解同时也可以通过这个平台去获取打赏而赚取一定的外快。


- 网站规划：
1. 网站的非更新性内容：关于页面、联系方式、导航栏、网站标题及logo
2. 网站的更新性内容：大数据、数据空间、网站报告、最新文章、学习论坛
3. 更新性内容的优先级：大数据=数据空间>网站报告
4. 基于用户调研和访谈，使用DVF模型定义需求——与网站的前期规划对比，暂缓平台经济这一模块功能。同时明确本网站是要用优质文章吸引用户，以达到前期目标。

![dvf.png](https://raw.githubusercontent.com/LUOJIHAO/web-operation/master/img/dvf.png)

- 网站地图：
![map.jpg](https://raw.githubusercontent.com/LUOJIHAO/web-operation/master/img/map.jpg)

---

### 1.2 图库版权
- 本网站图片的主要来源：[花瓣网](https://huaban.com/) 

- 详细版本见[图片版权](https://luojiahao.me/site-report/gallery-of-copyright/)文章
![picture.png](https://raw.githubusercontent.com/LUOJIHAO/web-operation/master/img/picture.png)
...
![user5.png](https://raw.githubusercontent.com/LUOJIHAO/web-operation/master/img/user5.png)
